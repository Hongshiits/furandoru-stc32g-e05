...
void PORT1_Init(void)
{
    ...
    SetP1nPushPullMode(PIN_0);          //设置P1.0为推挽输出模式
    SetP1nHighZInputMode(PIN_6 | PIN_5 | PIN_4 | PIN_3 | PIN_2 | PIN_1); //设置P1.6,P1.5,P1.4,P1.3,P1.2,P1.1为高阻输入模式
    SetP1nOpenDrainMode(PIN_7);         //设置P1.7为开漏模式
...
void PORT3_Init(void)
{
    ...
    SetP3nQuasiMode(PIN_1 | PIN_0);     //设置P3.1,P3.0为准双向口模式
    SetP3nPushPullMode(PIN_7 | PIN_6 | PIN_5 | PIN_4 | PIN_3 | PIN_2); //设置P3.7,P3.6,P3.5,P3.4,P3.3,P3.2为推挽输出模式
